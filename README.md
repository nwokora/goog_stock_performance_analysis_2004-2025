...
|----|----------|-------------|
| Q1 | Medical Condition vs Age Distribution of Patients | - Children represent ~2-3% of hospital admissions. Though rarely hospitalised for adult-onset conditions like hypertension(11), diabetes(16), and arthritis(21). - Arthritis dominates overall volume (9218 patients) but shows balanced age distribution |
